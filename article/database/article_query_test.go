...
func assertArticleTableValues(t *testing.T, db *gorm.DB, a *model.Article) {
...
func assertArticleExtraFields(t *testing.T, a *model.Article, tagValues string, favorited bool, favoritesCount int) {
